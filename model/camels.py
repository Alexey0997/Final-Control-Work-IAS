"""Модуль, реализующий класс Camels (верблюды), наследуемый от класса PackAnimals."""
from model.pack_animals import PackAnimals


class Camels(PackAnimals):
    """Конструктор класса Camels, в котором:
        - name       - имя животного;
